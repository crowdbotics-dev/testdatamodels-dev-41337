...
## Project Structure
    ...
    ├── testdatamodels_dev_41337  # Django project configurations
...
1. Clone this repo and `cd testdatamodels_dev_41337`
...
2. Clone this repo and `cd testdatamodels_dev_41337`
